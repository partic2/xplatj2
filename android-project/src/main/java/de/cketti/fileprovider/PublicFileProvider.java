 ...
 *
 * =======================================
 * patched by Pursuer to implement a simple File provider
 */
...
public class PublicFileProvider extends ContentProvider {
    ...
    public static Uri getUriForFile(Context context, String authority, File file) {
        PathStrategy strategy = new SimplePathStrategy(authority);
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            path = Uri.encode("file") + '/' + Uri.encode(path, "/");
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (!"file".equals(tag)) {
                throw new IllegalArgumentException("Path must prefix with 'file' :" + uri);
            }
