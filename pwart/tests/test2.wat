...
(table $stdiols 3 funcref)
  ...
  (func $test1 (result i64) (local $mem2 i64)(local $stdout funcref)(local $impAddTwo funcref)
    (local.set $mem2 (call $malloc (i32.const 128)))
    (i64.store $mem1 (local.get $mem2) (call $addTwo (i64.const 123000) (i64.const 456)) )
    i32.const 1


    (call $dimport (call $thismodule) (call $ref_from_index (i32.const 1)(i32.const 32)) (call $ref_from_index (i32.const 1)(i32.const 38)) (i32.const 0))
    table.set $stdiols

    (i64.add (i64.const 8) (local.get $mem2))
    (i64.const 456000)(i64.const 789)
    (call_indirect  $stdiols (type $typeAddTwo) (i32.const 1))
    i64.store $mem1
